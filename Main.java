...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        String strings = sc.nextLine(); // сканирую строку в массив с разделением данных по пробелу

        String u = calc(strings);
    ...
    public static String calc(String input) throws Exception {
        ...
        if (a.contains("I") || a.contains("II") || a.contains("III") || a.contains("IV") || a.contains("V") || a.contains("VI") || a.contains("VII") || a.contains("VIII") || a.contains("IX") || a.contains("X")) {  // проверка на счисление первой переменной для запуска римского калькулятора
            ...
            int x = rome.indexOf(a)+1;                      // перевожу введенные римские в арабский индекс строки
            int y = rome.indexOf(b)+1;
            ...
            int sumRom = (x + y)-1;                              // арифметические операции
            int differenceRom = (x - y)-1;
            int multiplicationRom = (x * y)-1;
            int divisionRom = (x / y)-1;
        ...
        // начало арабского калькулятора
            ...
            if (a.contains("1") || a.contains("2") || a.contains("3") || a.contains("4") || a.contains("5") || a.contains("6") || a.contains("7") || a.contains("8") || a.contains("9") || a.contains("10")) {
